...
6. Центральний crosshair на HUD допомагає цілитись у holdable-об'єкти з центру екрана.
...
- [ ] виправити ривковий рух предмета в руках під час переміщення гравця
- [ ] зробити переміщення гравця менш лінійним через криву руху
